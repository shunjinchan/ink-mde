...
- ![](../assets/ce7f8cfe212bec0f53360422e3b03a9e.png){:height 473, :width 776}
  Chrome 的任务管理器窗口
...
- ### 线程 VS 进程
    - 多线程可以并行处理任务，但是线程是不能单独存在的，它是由进程来启动和管理的。那什么又是进程呢？
      ...
      ![](../assets/3380f0a16c323deda5d3a300804b95da.png)
    ...
    - 总结来说，进程和线程之间的关系有以下 4 个特点。
        ...
        - ==2. 线程之间共享进程中的数据。==
          ...
          ![](../assets/d0efacd7f299ed99e776cb97da2a799e.png)
...
- ## 单进程浏览器时代
    - 在了解了进程和线程之后，我们再来一起看下单进程浏览器的架构。顾名思义，单进程浏览器是指浏览器的所有功能模块都是运行在同一个进程里，这些模块包含了网络、插件、JavaScript 运行环境、渲染引擎和页面等。其实早在 2007 年之前，市面上浏览器都是单进程的。单进程浏览器的架构如下图所示：
      ...
      ![](../assets/6ddad2419b049b0eb2a8036f3dfff1ca.png)
...
![](../assets/cdc9215e6c6377fc965b7fac8c3ec960.png)
- ## 多进程浏览器时代
    ...
    - ### 目前多进程架构
      id:: 63eb4c3a-aa10-427f-8f80-c755b8b824be
        - 不过 Chrome 的发展是滚滚向前的，相较之前，目前的架构又有了很多新的变化。我们先看看最新的 Chrome 进程架构，你可以参考下图：
            - ![](../assets/b61cab529fa31301bde290813b4587fc.png)
              最新的 Chrome 进程架构图
...
- ### 未来面向服务的架构
    ...
    - ![](../assets/329658fe821252db47b0964037a1de2a.png)
    ...
    - ![](../assets/a9ba86d7b03263fa3997d3733d958176.png)
    - 在资源不足的设备上，将服务合并到浏览器进程中
    - ![image.png](../assets/pasted_image_20220728113612.png)
- ## 总结
